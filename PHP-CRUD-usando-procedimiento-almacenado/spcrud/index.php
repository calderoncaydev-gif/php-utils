...
<div class="row">
<div class="col-md-12">
<h3>PHP CRUD usando Procedimiento Almacenado</h3> <hr />
<a href="insert.php"><button class="btn btn-primary"> Insertar Registros</button></a>
...
<tr>
    <td colspan="9" style="color:red; font-weight:bold;text-align:center;"> No hay registros</td>
</tr>
<?php } ?>    
</tbody>      
</table>
