	...
	<div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav menus">		
				...
				<li class="nav-item"><a class="nav-link" href="customer.php" id="customer_menu">Cliente</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="supplier.php" id="supplier_menu">Proveedor</a></li>
				<li class="nav-item"><a class="nav-link" href="product.php" id="product_menu">Producto</a></li>
		...
		<ul class="nav navbar-nav">
			<li class="dropdown position-relative">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
					<li><a class="dropdown-item" href="action.php?action=logout">Salir</a></li>
				</ul>
			</li>
		</ul>
	</div>
